 ...
 */
export const calculateScore = (dice: Die[], category: ScoringCategory): number => {
 ...
 */
export const isYahtzee = (dice: Die[]): boolean => {
  const values = dice.map(d => d.value);
 ...
 */
export const isCategoryAvailable = (player: Player, category: ScoringCategory): boolean => {
 ...
 */
export const getDiceTotal = (dice: Die[]): number => {
 ...
 */
export const shouldShowYahtzeeBonus = (gameState: GameState): boolean => {
 ...
 */
export const getPotentialScore = (gameState: GameState, category: ScoringCategory): number | null => {
 ...
 */
export const getUpperTotal = (player: Player): number => {
 ...
 */
export const getLowerTotal = (player: Player): number => {
  const lowerCategories: ScoringCategory[] = ['threeOfAKind', 'fourOfAKind', 'fullHouse', 'smallStraight', 'largeStraight', 'yahtzee', 'chance'];
 ...
 */
export const getTotalScore = (player: Player): number => {
 ...
 */
export const isCategoryUsed = (player: Player, category: ScoringCategory): boolean => {
  return player.scoreCard[category] !== undefined;
};
